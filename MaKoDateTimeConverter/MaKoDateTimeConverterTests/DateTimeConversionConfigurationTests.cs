...
namespace MaKoDateTimeConverterTests
{
    ...
    public class DateTimeConversionConfigurationTests
    {
        [Test]
        [TestCase(
            "{\"source\":{\"isGas\":false, \"isEndDate\": false}, \"target\":{\"isGas\":true, \"isGasTagAware\": true, \"isEndDate\": true, \"endDateTimeKind\":\"EXCLUSIVE\"}}"
        )]
        public void Test_Deserialization(string dateTimeConversionConfigJson)
        {
            var dateTimeConversionConfig =
                System.Text.Json.JsonSerializer.Deserialize<DateTimeConversionConfiguration>(
                    dateTimeConversionConfigJson
                );
        ...
        [TestCase(
            "{\"source\":{\"isGas\":false, \"isEndDate\": false}, \"target\":{\"isGas\":true, \"isGasTagAware\": true, \"isEndDate\": false}}",
            false
        )] // conversion between strom and gas
        [TestCase(
            "{\"source\":{\"isGas\":false, \"isEndDate\": false}, \"target\":{\"isGas\":false, \"isEndDate\": true, \"endDateTimeKind\":\"EXCLUSIVE\"}}",
            false
        )] // conversion between end and non-end date
        public void Test_Validation(string dateTimeConfigJson, bool isValid)
        {
            ...
            dateTimeConfig
                ...
                .And.Subject.As<DateTimeConversionConfiguration>()
                .IsValid.Should()
                .Be(isValid);
